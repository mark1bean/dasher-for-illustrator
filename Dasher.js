...
Dasher.prototype.basicPatternForLength = function (len) {
    ...
    // this method preserves dash|gap lengths
    // but last may be truncated
...
Dasher.getScaledRepetitions = function (pattern, scaleFactor, reps, dontSplitFirstDash) {
    // scale and repeat the pattern values
    var scaledValues = [],
        repeatScaledValues = [];
...
Dasher.prototype.toString = function (len) {
